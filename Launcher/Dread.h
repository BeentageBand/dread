...
/*
  ...
  Background.
  After several field work, the Master and Slave software version have some
  bugs. When the network falls, some DReads in the network may crash.

  DRead Software Revision 1.3
  T21O2014

  Background.
  After several field work, the Master has GPRS connection troubleshooting. Some
  fake GPRS disconnections may happen. This version intention is to suppress the
  software disconnections. GPRS disconnections should happen only if they are
  cellphone provider troubleshooting.
  In addition, the DreadBird program needs new file format. These format
