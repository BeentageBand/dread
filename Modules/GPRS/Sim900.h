...
public:
  ...
  void begin(const uint16_t baud_rate, const uint8_t rst_pin,
             const uint8_t nopowerdown_pin);
  void ATCmd(const uint8_t *atcmd);
  void ATCmdC(const uint8_t *atcmd);
  boolean setAtCmd(const uint8_t *atcmd, const uint8_t *expected_response,
  ...
  boolean setAtParameter(const uint8_t *atcmd, const uint8_t *expected_reponse,
                         const uint8_t *set_parameter,
                         const uint8_t parameter_size, const uint32_t timeout);
  boolean setAtParameter(const uint8_t *atcmd, const uint8_t *expected_reponse,
