...
#define TCR                                                                    \
  0x30 // Read/Write *only when ERF[4] = 1 and MCR[2] = 1, Original Reg: 0x06
#define TLR                                                                    \
  0x38 // Read/Write *only when ERF[4] = 1 and MCR[2] = 1, Original Reg: 0x07
...
#define IOInteEna                                                              \
  0x60 // Read/Write *only on SC16IS750/SC16IS760 Original Reg: 0x0C
#define IOControl                                                              \
  0x70            // Read/Write *only on SC16IS750/SC16IS760 Original Reg: 0x0E
...
#define EFR                                                                    \
  0x10 // Read/Write *only when LCR is set to 1011 1111b (0xBF). Original Reg:
       // 0x00
